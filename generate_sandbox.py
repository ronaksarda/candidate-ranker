...
# 1. Create the notebook JSON structure
notebook = {
    'cells': [
        {
            'cell_type': 'markdown',
        ...
        },
        {
            ...
            'metadata': {},
            'outputs': [],
            'source': ['!pip install -q transformers torch sentence-transformers pandas']
        },
        {
            'cell_type': 'markdown',
            'metadata': {},
        ...
        },
        {
            'cell_type': 'markdown',
            'metadata': {},
            'source': ['### 2. The Plausibility Filter (Fraud Detection)']
        },
        {
            'cell_type': 'code',
            'metadata': {},
        ...
        },
        {
            'cell_type': 'markdown',
            'metadata': {},
            'source': ['### 3. Pipeline Execution (Bi-Encoder + Cross-Encoder)']
        },
        {
            'cell_type': 'code',
            'metadata': {},
...
with open('Redrob_Colab_Sandbox.ipynb', 'w', encoding='utf-8') as f:
    json.dump(notebook, f, indent=2)

print("Created Redrob_Colab_Sandbox.ipynb")

# 2. Extract 50 candidates from the dataset to create test_candidates.jsonl
source_path = r"C:\Users\rocky\OneDrive\Documents\Hackathon_RedrobAI\[PUB] India_runs_data_and_ai_challenge\India_runs_data_and_ai_challenge\candidates.jsonl"
dest_path = "test_candidates.jsonl"

ml_keywords = ["machine learning", "ml ", "ai ", "data scientist", "nlp", "search", "retrieval", "ranking", "recommend"]
...
try:
    ...
    print(f"Created {dest_path} with 50 test candidates.")
